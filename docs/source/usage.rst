...
group2-ID determines which group is used for neighbor selection (optional, default “all”)<br/>

For example:

   compute 1 all ptm/atom default 0.1 all<br/>
   compute 1 all ptm/atom fcc-hcp-dcub-dhex 0.15 all<br/>
   compute 1 all ptm/atom all 0<br/>
